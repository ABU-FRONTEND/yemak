  ...
  return (
    <header className=" bg-header flex items-center h-[400px] bg-no-repeat bg-cover" >
        <div className={`${styles.container} flex justify-between`}>
            ...
            <input type="text" onFocus={() => setIsOpen(true)} onBlur={() => setIsOpen(false)} placeholder="Restoran yoki taom nomi" className=" w-full h-[2.8rem] placeholder:opacity-[0.8] outline-none rounded-[6.4px] z-30 relative px-[1rem] text-[0.9rem]"/>
